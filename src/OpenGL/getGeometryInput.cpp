...
int getGeometryInput(std::vector<triangle> &facet, std::string STL_files_path, std::string STL_filename)
{
        int error = read_binary_STL_file (facet, STL_files_path, STL_filename);
...
int read_binary_STL_file(std::vector<triangle> & facet, std::string STL_files_path, std::string STL_filename)
{
    double x_min, x_max, y_min, y_max, z_min, z_max;

    //std::string STL_filename="Link0.stl";

    // specify the location of STL files on this computer
    //std::string STL_files_path = "C:/Users/jeor_/Desktop/IRB120/";
